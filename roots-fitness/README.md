...
- **セミパーソナルの月額・回数制プラン**: チケット制終了後、通い放題(月33,000円)・単発都度(1回12,000円)・ペアレッスン(1回14,000円/お一人様7,000円)は反映済み。ただし「セミパーソナルも月額で月に何回通える」という、パーソナルの週1回/週2回コースに相当する回数制の月額プランがあるとの話があり、まだ`data/plans.json`に追加できていない。何回通えるプランを何段階(週1回相当/週2回相当など)用意するか、それぞれの月額料金がいくらかを確認したい
